...
<div class="container" style="width: 300px;">
  ...
  <form action="${loginUrl}" method="post">
    <h2 class="form-signin-heading">Please sign in system</h2>
    <input type="text" class="form-control" name="j_username" placeholder="Email_address" required autofocus value="root">
