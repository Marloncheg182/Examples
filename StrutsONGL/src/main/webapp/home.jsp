...
<s:form action="welcome" method="POST">
    ...
    <table>
        <s:textfield name="userList.name" label="User 1 Name"></s:textfield>
        <s:textfield name="userList.name" label="User 2 Name"></s:textfield>
        <s:textfield name="userList.name" label="User 3 Name"></s:textfield>
    </table>
    ...
    <table>
        <s:textfield name="userMap['first'].name" label="User 1"></s:textfield>
        <s:textfield name="userMap['second'].name" label="User 2"></s:textfield>
        <s:textfield name="userMap['third'].name" label="User 3"></s:textfield>
    </table>
